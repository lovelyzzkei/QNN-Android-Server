 ...
 */
package com.lovelyzzkei.qnnSkeleton.common.helpers;
...
public class DepthSettings {
  ...
  private boolean arCoreDepthColorVisualizationEnabled = false;
  private boolean ariaDepthColorVisualizationEnabled = false;
  private boolean odEnabled = false;
  ...
  public boolean arCoreDepthColorVisualizationEnabled() {
    return arCoreDepthColorVisualizationEnabled;
  }
  public boolean odEnabled() {
    return odEnabled;
  }


  public void setARcoreDepthColorVisualizationEnabled(boolean arCoreDepthColorVisualizationEnabled) {
    this.arCoreDepthColorVisualizationEnabled = arCoreDepthColorVisualizationEnabled;
  }
